...
int main() {
	...
	p1.AddPreferences("Hola", "Adios", "Ok");
	p2.AddPreferences("Perfecto", "Gracias", "Buenas");
	p1.ShowPreferences();
	p2.ShowPreferences();
	p1.AddPreference("Pepito");
	p2.AddPreference("Juanito");
	p1.ChangePreference(1, "Nuevo");
	p2.ChangePreference(1, "New");
	p1.ShowPreferences();
	p2.ShowPreferences();
}
